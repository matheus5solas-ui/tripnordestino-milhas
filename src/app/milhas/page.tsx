...
const programs = [
  { name: "LATAM Pass", status: "Ofertas ativas", latest: "Aniversário LATAM Pass", latestDetail: "Central oficial mantém a campanha de aniversário até 10/10/2026, além de Marriott Bonvoy e Shopee.", cost: "Depende da oferta selecionada", note: "Consulte as condições da oferta oficial antes de acumular, transferir ou resgatar milhas." },
