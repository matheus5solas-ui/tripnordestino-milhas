...
const programs = [
  { name: "LATAM Pass", status: "Transferência com bônus ativa", latest: "25% de bônus + 1.500 milhas extras", latestDetail: "Campanha Livelo → LATAM Pass válida até 22/09/2026 às 23h59; transferência mínima de 12.000 pontos.", cost: "R$ 25,59/milhar na simulação vigente", note: "Simulação Livelo observada em 22/09: 12.000 pontos transferidos, 120 pontos usados + R$ 383,84, gerando 15.000 milhas LATAM com o bônus de 25%. R$ 383,84 ÷ 15 = R$ 25,59/milhar (desembolso em dinheiro; não atribui custo aos 120 pontos usados). Com 5% no PIX ou 1.500 milhas extras da primeira transferência, o custo efetivo pode ser menor." },
