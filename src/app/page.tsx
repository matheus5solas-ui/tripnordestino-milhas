...
export default function Home() {
  return <main>
    <div className="hero" id="buscar">
      ...
      <div className="hero-copy"><span className="hero-kicker"><Sparkles size={14}/> Em desenvolvimento</span><h1>Viaje mais.<br/><em>Compare melhor.</em></h1><p>Encontre passagens em dinheiro e milhas<br className="desktop-break"/> e escolha a opção que vale mais a pena.</p></div>
      <SearchBox/>
